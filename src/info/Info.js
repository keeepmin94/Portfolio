...
export const info = {
  ...
  bio:
    ...
    `백엔드 개발을 집중적으로 학습하였고 주력 프레임워크는 Nest.JS로 WAS 개발과 설계 및 베포 환경을 구축 했습니다.  \n` +
    `\n` +
    `개발자로서 개발 스킬만을 중요하게 여기지 않고 협업을 중요시하여 끊임없이 소통합니다. 또한, 체계적인 업무 일정 관리를 통해 매주 우선순위의 업무를 구분 짓고, 업무 세분화 작업으로 일정에 차질이 생기지 않게 합니다.`,
  skills: {
    proficientWith: [
      "javascript",
      "react",
